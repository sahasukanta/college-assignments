class BoundedQueue:
    ...
    def dequeue(self):
        ...
        if len(self.__items) <= 0:
            ...
            raise Exception("Error: Queue cannot be dequeued as its empty.")
...
def main():
    ...
    # .size returns the current length of bq
    # .capacity returns the max length (how many it can hold) when its full i.e. the ammount of memory it was initiated with
    print('----------------------------------')
    ...
    # print(bq.capacity) -returns the self.capacity() method of this class
    # print(bq.__capacity)  --returns AttributeError
