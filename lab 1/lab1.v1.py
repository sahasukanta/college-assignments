...
"""
So the order of the placeholder that you put in the curly brackets is: index of the thing 
you want, colon, filler character (like 0 or * or a space),
< > ^ depending if you want it left right or centred, then decimal point if you want decimals
" efw wef we  {index:0*<^>10.2}".format()
"""
