    ...
    while not close:
        ...
        while innerLoop:
            ...
            if inp == '1':
                ...
                # print(summary, totalDeliveryCost, percDelCost, totalDrivers) # -->>>>> printing out the correctly formatted summary here
                print("+", "-"*15, "+", "-"*12, "+", "-"*11, "+", sep='')
            ...
            # option 2 - orders by address
                ...
                if addrInp in allAddr:
                    ...
                    for i in invoice:
                        total += i[-1]
                    # print(invoice) # -->>>>> printing out the correctly formatted invoice here
                    # print(total)
                    ...
                    #     print("{0} {1}  {2:0>3} x {3:" "<20}  ${4}".format(months[line[0][5:7]], line[0][8:], line[1], itemDescription, subTotal))
                    # print(" "*35, "--------")
                    # print(" "*35, "$%7.2f"%total)
...
def driversNeeded(num):
    """returns the number of drivers needed for each zone depending on the number of deliveries"""
    result = num//10
    if result != num/10:
        result += 1
    return result
